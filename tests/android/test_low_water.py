...
class LowWaterContent(unittest.TestCase):
 ...
 def test_complete_scene_marker_cannot_be_reused_after_failed_build(self):
  gate=(ROOT/'tools/scene/editor_gate.sh').read_text();self.assertIn('field-content,county-content,county-runtime,companion-runtime,scene-ready,render-verification',gate)
