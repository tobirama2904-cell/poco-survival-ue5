...
rm -f artifacts/gameplay-scene/{scene-construction,city-construction,field-content,county-content,county-runtime,companion-runtime,companion-support,melee-runtime,scene-ready,render-verification}.json
