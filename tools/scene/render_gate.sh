...
rm -f artifacts/gameplay-scene/*.png artifacts/gameplay-scene/runtime-movement.json artifacts/gameplay-scene/county-runtime.json artifacts/gameplay-scene/render-verification.json
