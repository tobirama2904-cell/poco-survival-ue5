...
rm -f artifacts/gameplay-scene/*.png artifacts/gameplay-scene/runtime-movement.json artifacts/gameplay-scene/render-verification.json
...
timeout --foreground 15m xvfb-run -a -s '-screen 0 960x540x24' \
  ...
  -windowed -ResX=960 -ResY=540 -unattended -nosound -nop4 -nosplash \
