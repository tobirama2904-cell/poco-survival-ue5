...
rm -f artifacts/gameplay-scene/*.png artifacts/gameplay-scene/runtime-movement.json artifacts/gameplay-scene/county-runtime.json artifacts/gameplay-scene/companion-runtime.json artifacts/gameplay-scene/render-verification.json
...
timeout --foreground 25m xvfb-run -a -s '-screen 0 640x360x24' \
