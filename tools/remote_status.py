...
def main():
    ...
    parser.add_argument('--workflow', choices=['core', 'engine', 'android'], default='core')
    ...
    while True:
        ...
        workflow_path = '.github/workflows/' + {'core':'core-tests.yml','engine':'engine-probe.yml','android':'android-native.yml'}[args.workflow]
        ...
        result = ({'commit': args.commit, 'id': core['id'], 'url': core['html_url'],
                   ...
                   'test_scope': ('portable domain C++; NOT Unreal or Android' if args.workflow == 'core' else ('Android native source compilation; NOT cooked content or an APK' if args.workflow == 'android' else 'UHT/UBT and headless Unreal integration; NOT Android or visual gameplay'))} if core else
